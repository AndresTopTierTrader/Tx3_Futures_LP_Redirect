...
export function SocialMedia() {
    ...
    const socialIcons = [
        ...
        { id: 'twitter', default: TwitterIcon, color: TwitterIconColor, alt: 'Twitter Icon', link: "https://x.com/i/flow/login?redirect_after_login=%2Ftx3funding" },
    ...
    return (
        <section className="flex flex-col mb:flex-row justify-center">
